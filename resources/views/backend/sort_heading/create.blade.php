...
@section('title','Create sort headings')
@section('content')
    <div class="row">
        <div class="col-sm-10 col-sm-offset-2 col-lg-10">
            <h2><a href="{{route('headings.index')}}"> Blog sort headings </a> ≫
            ...
            @endif
            <form action="{{route('headings.store')}}" method="POST" enctype="multipart/form-data"  data-parsley-validate = "" >
                {{csrf_field()}}
                <div class="row">
                    <div class="col-sm-10">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <a class="btn btn-primary" href="{{route('headings.index')}}" type="button"> Cancel </a>
                        </div>
                    </div>
                </div>
            </form>
