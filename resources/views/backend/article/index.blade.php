                    ...
                    @if(!$data['rows']->isEmpty())
                        ...
                        @foreach($data['rows'] as $row)
                            <tr>
                                ...
                                <td align="center">
                                    {!! Form::model($row,array('route'=>['article.destroy',$row->id],'method'=>'delete','id'=>'form'.$row->id,'enctype'=>'multipart/form-data')) !!}

                                    {{--@if (AppHelper::isRouteAccessable('article.edit'))--}}
                                    <a href="{{route('article.edit',$row->id)}}" class="btn btn-primary"><i
