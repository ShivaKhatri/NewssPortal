...
@section('content')
    <div class="row">
        <div class="col-sm-10 col-sm-offset-2 col-lg-10">
            <h2><a href="{{route('videos.index')}}"> Blog Posts </a> ≫
            ...
            @endif
            <form action="{{route('videos.store')}}" method="POST" enctype="multipart/form-data"  data-parsley-validate = "" >
                {{csrf_field()}}
                <div class="row">
                    <div class="col-sm-10">
                ...
                <div class="row">
                    <div class="col-sm-10">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="file" name="file" accept="videos/*" />
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <a class="btn btn-primary" href="{{route('videos.index')}}" type="button"> Cancel </a>
                        </div>
                    </div>
                </div>
            </form>
