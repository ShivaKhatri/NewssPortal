...
@section('content')
    <div class="row">
        <div class="col-sm-10 col-sm-offset-2 col-lg-10">
            <h2><a href="{{route('videos.index')}}"> Video</a> ≫
                <small>@yield('title')</small>
            </h2>
            {!! Form::model($data['row'], [
             'route' => ['videos.update', $data['row']->id, 'class' =>"form-horizontal form-label-left"],
             'method' => 'PUT',
             'id' => 'demo-form2',
            ...
            !!}
                ...
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <a class="btn btn-warning" href="{{route('videos.index')}}" type="button"> Cancel </a>
