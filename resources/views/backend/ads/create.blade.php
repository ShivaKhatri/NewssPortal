...
@section('content')
    <div class="row">
        <div class="col-sm-10 col-sm-offset-2 col-lg-10">
            <h2><a href="{{route('ads.index')}}"> Create Ads </a> ≫
            ...
            @endif
            <form action="{{route('ads.store')}}" method="POST" enctype="multipart/form-data"  data-parsley-validate = "" >
                {{csrf_field()}}
                <div class="row">
                    <div class="col-sm-10">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <a class="btn btn-primary" href="{{route('ads.index')}}" type="button"> Cancel </a>
                        </div>
                    </div>
                </div>
            </form>
