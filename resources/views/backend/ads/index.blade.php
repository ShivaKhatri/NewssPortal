    ...
    <div class="x_panel">
        ...
        >
            ...
            <ul class="nav navbar-right panel_toolbox">
                ...
                <a href="{{route('ads.create')}}"><button class="btn btn-success"><li><i class="fa fa-plus">Add</i>
                        </li></button></a>
            </ul>
                        ...
                        @foreach($data['rows'] as $row)
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    {{--@if (AppHelper::isRouteAccessable('ads.edit'))--}}
                                    <a href="{{route('ads.edit',$row->id)}}" class="btn btn-primary"><i
                                                class="glyphicon glyphicon-edit"></i></a>

                                    {{--@endif--}}
                                    {{--                                    @if (AppHelper::isRouteAccessable('ads.destroy'))--}}
