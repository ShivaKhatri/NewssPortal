...
@section('content')
    <div class="row">
        <div class="col-sm-10 col-sm-offset-2 col-lg-10">
            <h2><a href="{{route('ads.index')}}"> Ads</a> ≫
                <small>@yield('title')</small>
            </h2>
            {!! Form::model($data, [
             'route' => ['ads.update', $data->id, 'class' =>"form-horizontal form-label-left"],
             'method' => 'PUT',
             'id' => 'demo-form2',
            ...
            !!}
                ...
                <div class="row">
                    <div class="col-sm-10">
                        ...
                        @if(!empty($data->image))
                            <img src="{{asset('assets/uploads/ads/'.$data->image)}}" height="200" width="200"/>
                        @endif
                    </div>
                </div>
                <div class="row">
                ...
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <a class="btn btn-warning" href="{{route('ads.index')}}" type="button"> Cancel </a>
