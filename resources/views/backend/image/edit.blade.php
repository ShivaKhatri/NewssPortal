...
@section('title','Edit Image Of The Month')
@section('content')
    <div class="row">
        <div class="col-sm-10 col-sm-offset-2 col-lg-10">
            <h2><a href="{{route('images.index')}}"> Image Of The Month</a> ≫
                <small>@yield('title')</small>
            </h2>
            {!! Form::model($data['row'], [
             'route' => ['images.update', $data['row']->id, 'class' =>"form-horizontal form-label-left"],
             'method' => 'PUT',
             'id' => 'demo-form2',
            ...
            !!}
                ...
                <div class="row">
                    <div class="col-sm-10">
                        ...
                        @if(!empty($data['row']->image))
                            <img src="{{asset('assets/uploads/image/'.$data['row']->image)}}" height="200" width="200"/>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <a class="btn btn-warning" href="{{route('images.index')}}" type="button"> Cancel </a>
